...
Update @table_disk set Size= 15 where drive ='D'
Update @table_disk set Size= 40 where drive ='E'
Update @table_disk set Size= 20 where drive ='F'
Update @table_disk set Size= 15 where drive ='G'
Update @table_disk set Size= 20 where drive ='H'
